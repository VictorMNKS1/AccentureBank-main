...
public class SwaggerConfig {
    ...
    public Docket detalheApi() {
        ...
        docket
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("accenturebank.com.accentureBank"))
    ...
    private ApiInfoBuilder informacoesApi() {
        ...
        apiInfoBuilder.title("Accenture Bank - API");
        apiInfoBuilder.description("API BANK ACC");
        apiInfoBuilder.version("1.0");
        apiInfoBuilder.termsOfServiceUrl("Termo de uso: Accenture BANK");
